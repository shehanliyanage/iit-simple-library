...
class Routes(
  ...
  def documentation = List(
    ...
    ("""GET""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """books""", """controllers.HomeController.index"""),
    ("""POST""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """books""", """controllers.HomeController.addBook"""),
    Nil
  ...
  // @LINE:15
  private[this] lazy val controllers_HomeController_addBook3_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("books")))
  )
  private[this] lazy val controllers_HomeController_addBook3_invoker = createInvoker(
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:15
    case controllers_HomeController_addBook3_route(params@_) =>
      call { 
        controllers_HomeController_addBook3_invoker.call(HomeController_0.addBook)
      }
  }
}
